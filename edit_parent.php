<?php
include('check_parent.php'); //check if user if a member
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
		$update = mysqli_query($connection, "UPDATE parent SET upload='$target_file' WHERE icno='$icno'") or die(mysqli_error()); // query for update data in database
...
<div class="col-sm-3">
<input type="occu" name="occu" value="<?php echo $row ['occu']; ?>" class="form-control" placeholder="Occupation" required>
</div>
</div>
<div class="form-group">
