<?php
include('check_parent.php'); //check if user if an administrator
include('header_parent.php'); //load header content for admin page
include("connection.php"); // connection to database
?>
<div class="container" style="margin-top:50px">
<div class="content">
<h2>Change Parent Password &raquo;</h2>
<hr />
<?php
...
<a href="parent.php" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Cancel"><b>Cancel</b></a>
</div>
</div>
</form>
</div> <!-- /.content -->
