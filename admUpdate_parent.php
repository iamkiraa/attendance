...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
		$update = mysqli_query($connection, "UPDATE parent SET upload='$target_file' WHERE parentID='$parentID'") or die(mysqli_error()); // query for update data in database
...
$update = mysqli_query($connection, "UPDATE parent SET name='$name', gender='$gender', dob='$dob', address='$address', phone='$phone', email='$email', occu='$occu', childName='$childName' WHERE parentID='$parentID'") or die(mysqli_error()); // query for update data in database
