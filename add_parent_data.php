...
include('check_parent.php'); //check if member logged in
include('header_parent.php'); //load header content for member page
include("connection.php"); // connction to database
?>
<div class="container" style="margin-top:50px">
<div class="content">
<h2>Add Parent Data &raquo;</h2>
<hr />
<?php
...
$insert = mysqli_query($connection, "INSERT INTO parent(icno, name, gender, dob, address, phone, email, occu,
 childName) VALUES('$icno','$name', '$gender', '$dob', '$address', '$phone', '$email', '$occu', '$childName')")
...
<div class="col-sm-3">
<input type="occu" name="occu" class="form-control" placeholder="Occupation" required>
</div>
</div>
<div class="form-group">
